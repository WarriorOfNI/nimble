...
const metadata: Meta<TableArgs> = {
    ...
    render: createUserSelectedThemeStory(html<TableArgs>`
        ...
        <nimble-table :data=${x => dataSets[x.data]} id-field-name=${x => dataSetIdFieldNames[x.data]}>
            <nimble-table-column-text field-name="firstName" placeholder="no value" fractional-width=".5">First Name</nimble-table-column-text>
            ...
            <nimble-table-column-text field-name="quote" placeholder="no value" fractional-width="2">Quote</nimble-table-column-text>
        </nimble-table>
